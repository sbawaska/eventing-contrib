...
func (a *registryAdapter) newRouter(hook *gh.Webhook) *http.ServeMux {
...
func (a *registryAdapter) HandleEvent(payload interface{}, header http.Header) error {
	err := a.handleEvent(payload, header)
	return err
}

func (a *registryAdapter) handleEvent(payload interface{}, hdr http.Header) error {
