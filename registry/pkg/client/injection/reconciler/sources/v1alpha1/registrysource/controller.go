...
import (
	...
	versionedscheme "knative.dev/eventing-contrib/registry/pkg/client/clientset/versioned/scheme"
...
const (
	defaultControllerAgentName = "registrysource-controller"
	defaultFinalizerName       = "registrysources.sources.knative.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	rec := &reconcilerImpl{
		...
		Lister:        registrysourceInformer.Lister(),
		reconciler:    r,
