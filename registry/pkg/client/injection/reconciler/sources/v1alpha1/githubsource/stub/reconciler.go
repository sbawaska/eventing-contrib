...
import (
	...
	githubsource "knative.dev/eventing-contrib/github/pkg/client/injection/reconciler/sources/v1alpha1/githubsource"
...
// reason GitHubSourceReconciled.
func newReconciledNormal(namespace, name string) reconciler.Event {
	return reconciler.NewEvent(v1.EventTypeNormal, "GitHubSourceReconciled", "RegistrySource reconciled: \"%s/%s\"", namespace, name)
}
...
//var _ githubsource.Finalizer = (*Reconciler)(nil)
