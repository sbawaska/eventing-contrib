...
import (
	...
	v1alpha1 "knative.dev/eventing-contrib/github/pkg/client/listers/sources/v1alpha1"
)
...
// NewGitHubSourceInformer constructs a new informer for RegistrySource type.
...
// NewFilteredGitHubSourceInformer constructs a new informer for RegistrySource type.
// Always prefer using an informer factory to get a shared informer instead of getting an independent
// one. This reduces memory footprint and number of connections to the server.
